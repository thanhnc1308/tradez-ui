...
<script>
  ...
  import { on, off, getScrollContainer, isInContainer } from '@/components/BaseComponent/utils/dom';
  import { isString, isHtmlElement } from '@/components/BaseComponent/utils/types';
