...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from '@/components/BaseComponent/utils/date-util';
  import RepeatClick from '@/components/BaseComponent/directives/repeat-click';
